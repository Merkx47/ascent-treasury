...
export function LanguageSelector() {
  ...
  return (
    <div className="relative lang-selector-container">
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-52 py-2 bg-popover border border-border rounded-lg shadow-lg z-50 animate-in fade-in slide-in-from-top-2 duration-200">
